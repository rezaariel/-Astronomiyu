...
# Add local directory to path to allow importing from tools
sys.path.append(os.path.dirname(os.path.abspath(__file__)))
from tools.gauss_orbit import run_gauss
from tools.realtime_coords import open_coordinate_tracker
